...
goog.exportSymbol('proto.com.book.EchoMessage', null, global);
 ...
 * @constructor
 */
proto.com.book.EchoMessage = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.com.book.EchoMessage, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.com.book.EchoMessage.displayName = 'proto.com.book.EchoMessage';
}
 ...
 * @return {!Object}
 */
proto.com.book.EchoMessage.prototype.toObject = function(opt_includeInstance) {
  return proto.com.book.EchoMessage.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.com.book.EchoMessage} msg The msg instance to transform.
 * @return {!Object}
 */
proto.com.book.EchoMessage.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.com.book.EchoMessage}
 */
proto.com.book.EchoMessage.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.com.book.EchoMessage;
  return proto.com.book.EchoMessage.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.com.book.EchoMessage} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.com.book.EchoMessage}
 */
proto.com.book.EchoMessage.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.com.book.EchoMessage.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.com.book.EchoMessage.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.com.book.EchoMessage} message
 * @param {!jspb.BinaryWriter} writer
 */
proto.com.book.EchoMessage.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getValue();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.com.book.EchoMessage.prototype.getValue = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};


/** @param {string} value */
proto.com.book.EchoMessage.prototype.setValue = function(value) {
  jspb.Message.setField(this, 1, value);
};
