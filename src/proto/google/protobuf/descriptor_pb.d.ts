...
export namespace FileDescriptorSet {
    export type AsObject = {
        fileList: Array<FileDescriptorProto>,
    }
}
...
export namespace DescriptorProto {
    export type AsObject = {
        ...
        enumTypeList: Array<EnumDescriptorProto>,
        extensionRangeList: Array<DescriptorProto.ExtensionRange>,
        oneofDeclList: Array<OneofDescriptorProto>,
        options?: MessageOptions.AsObject,
        reservedRangeList: Array<DescriptorProto.ReservedRange>,
...
export class UninterpretedOption extends jspb.Message { 
    ...
    setStringValue(value: Uint8Array): void;
...
export namespace UninterpretedOption {
    export type AsObject = {
        nameList: Array<UninterpretedOption.NamePart>,
...
export namespace SourceCodeInfo {
    export type AsObject = {
        locationList: Array<SourceCodeInfo.Location>,
    }
...
export namespace GeneratedCodeInfo {
    export type AsObject = {
        annotationList: Array<GeneratedCodeInfo.Annotation>,
    }
